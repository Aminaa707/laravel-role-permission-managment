                    ...
                    <form method="POST" action="{{route('admin.users.update', $admin->id)}}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 com-sm-12 form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="user-name" value="{{$admin->name}}" aria-describedby="emailHelp" placeholder="Enter a Name">

                            </div>
                            <div class="col-md-6 com-sm-12 form-group">
                                <label for="email">Email</label>
                                <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="Enter a email" value="{{$admin->email}}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 com-sm-12 form-group">
                                ...
                                <input type="text" class="form-control" name="username" id="user_name" aria-describedby="emailHelp" placeholder="Enter a User Name" value="{{$admin->username}}">
