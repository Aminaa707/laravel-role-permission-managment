        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Create New User</h4>
                    ...
                    <form method="POST" action="{{route('admin.users.store')}}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 com-sm-12 form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="user-name" aria-describedby="emailHelp" placeholder="Enter a Name">
